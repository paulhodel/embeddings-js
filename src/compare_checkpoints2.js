/**
 * Checkpoint Comparison Script - Model 2 (Skip-gram)
...
const CONFIG = {
    ...
    outputFile: './data/metrics_over_time2.json',
    embeddingDim: 64,
};

async function main() {
    console.log('\n' + '='.repeat(60));
    console.log('CHECKPOINT COMPARISON - METRICS OVER TIME (MODEL 2)');
    ...
    const distinctionTests = [
        { word1: 'cat', word2: 'car', expectLow: true },
        { word1: 'happy', word2: 'table', expectLow: true },
        { word1: 'run', word2: 'mountain', expectLow: true },
        { word1: 'king', word2: 'three', expectLow: true },
    ];
    ...
    for (let cpIdx = 0; cpIdx < checkpointFiles.length; cpIdx++) {
        ...
        // TEST 5: Cross-category Distinction
        ...
        // TEST 6: Semantic Separation Score
    ...
    // ============================================
    console.log('\n' + '='.repeat(100));
    console.log('METRICS OVER TIME - SUMMARY (MODEL 2)');
