...
const CONFIG = {
    ...
    maxParquetFiles: 10,  // Limit number of files to process
...
async function main() {
    ...
    if (checkpointFiles.length > 0) {
        ...
        console.log(`\nFound existing checkpoint: ${latestCheckpoint}`);
        ...
        startFileIdx = checkpoint.currentFileIdx || 0;
        batchCount = checkpoint.batch;

        console.log(`Resuming from epoch ${startEpoch + 1}, file ${startFileIdx}, batch ${batchCount}`);
    }
